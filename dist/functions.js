...
function PropsSI(p, p1, v1, p2, v2, f) {
  return __awaiter(this, void 0, void 0, function () {
    var url, prop, res;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          url = "https://propssiapp.azurewebsites.net/api/PyPropsSI?code=QEkV7KLzrU/MwXgi45zN15FWhEwHDFKygQFTmqwQ6ZVwbw2G7gutUQ==";
          prop = {
            p: p,
            p1: p1,
            v1: v1,
...
CustomFunctions.associate("PROPSSI", PropsSI);
